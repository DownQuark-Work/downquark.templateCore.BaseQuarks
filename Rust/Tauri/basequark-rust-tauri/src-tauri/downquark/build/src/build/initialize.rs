...
// use crate::configuration::BaseQuarkConfig;
...
//   pub fn get_conf_file_paths(dq_conf:&BaseQuarkConfig) -> HashMap<String, HashMap<String, Vec<String>>> {
//     let local_validation_paths = BaseQuarkConfig::get_validation_paths(dq_conf.basequark.directory_parsed.home.to_string());
...
//     if total_validation_successes >= 4 { // basequark config file was located
...
//     let vision_toml_file_val = &toml_parse["basequark"]["vision"][0]["config_toml_file_path"];
...
//     if file_path.contains("_basequark") { // TODO: unharcode this
//       usr_toml_file_val = &toml_parse["basequark"]["session"]["last_active"];
//       vision_toml_file_val = &toml_parse["basequark"]["vision"][0]["config_toml_file_path"];
//     } else {
...
// pub async fn configure_app_launch_config(dq_conf:&BaseQuarkConfig) -> OnAppLaunchStruct {
//   // version and previous install of any dq app
//   let dq_config_file_paths = initialize::get_conf_file_paths(dq_conf);
//   let local_config_file_paths = vec![ dq_config_file_paths["LOCAL_VALIDATION"]["_DQ"].join("/"), dq_config_file_paths["LOCAL_VALIDATION"]["BASEQUARK"].join("/") ];
